...
export function getNames(questions: Question[]): string[] {
    const array = [...questions];
    const names = array.map((question: Question): string => question.name);
    return names;
}
...
export function sumPublishedPoints(questions: Question[]): number {
    const array = [...questions];
    const published = getPublishedQuestions(array);
...
export function addNewQuestion(
    ...
    const array = [...questions];
    const empty = makeBlankQuestion(id, name, type);
    array.push(empty);
    return array;
}
...
export function duplicateQuestionInArray(
    ...
    const array = [...questions];
    const index = array.findIndex((question) => question.id === targetId);
    array.splice(index + 1, 0, duplicateQuestion(newId, array[index]));
    return array;
}
